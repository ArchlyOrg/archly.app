        ...
        <div className='flex columns-3 content-center items-center justify-between px-10 py-3'>
          <div className='w-1/4 justify-start'>
            <div className='inline-flex'>
              <span className='text-xl font-black text-green-600 transition-colors  duration-200 ease-in-out dark:text-slate-400'>
                Archly
              </span>
              <MdAddLocationAlt
                className='text-xl text-green-600 transition-colors duration-200 ease-in-out dark:text-slate-500'
                name='logo'
              />
            </div>
          </div>
